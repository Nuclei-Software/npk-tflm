...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  ...
  // Initialize nmsis_nn input dimensions
  ...
  // Initialize nmsis_nn filter dimensions
  ...
  // Initialize nmsis_nn output dimensions
...
TfLiteStatus EvalQuantizedPerChannel(TfLiteContext* context, TfLiteNode* node,
  ...
  // riscv_convolve_wrapper_s8 dispatches the optimized kernel accordingly with
